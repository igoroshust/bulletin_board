...
urlpatterns = [
    ...
    path('responses/<int:publication_id>/create-response/', ResponseCreate.as_view(), name='response_create'),
    # path('responses/', response_list, name='response_list'),
    path('responses/', ResponseStatusList.as_view(), name='response_list'),
